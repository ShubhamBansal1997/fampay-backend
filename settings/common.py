...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    "DEFAULT_PAGINATION_CLASS": "fampay.base.api.pagination.LimitOffsetPagination",
    "PAGE_SIZE": 30,
    # Default renderer classes for Rest framework
    "DEFAULT_RENDERER_CLASSES": [
        "fampay.base.renderers.FampayApiRenderer",
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "fampay.users.auth.backends.UserTokenAuthentication",
        # Mainly used for api debug.
        "rest_framework.authentication.SessionAuthentication",
    ),
    "DEFAULT_SCHEMA_CLASS": "rest_framework.schemas.coreapi.AutoSchema",
    "EXCEPTION_HANDLER": "fampay.base.exceptions.exception_handler",
}
...
SITE_NAME = env("SITE_NAME", default="fampay")
...
FRONTEND_SITE_NAME = env("FRONTEND_SITE_NAME", default="fampay")
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///fampay")}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                "fampay.base.context_processors.site_settings",
...
CSRF_FAILURE_VIEW = "fampay.base.views.csrf_failure"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "fampay": {"handlers": ["console"], "level": "INFO", "propagate": False},
